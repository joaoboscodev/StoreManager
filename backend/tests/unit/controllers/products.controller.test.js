...
const { allProductsService, productByIdService, allProductsServiceError, productByIdServiceError, 
newProductByIdFromModel, productFromServiceCreated } = require('../mocks/products.mock');
